...
- Restored a working smoke-test flow for the packaged extension
- Aligned the bundle target with the declared VS Code compatibility floor
- Corrected TextMate highlighting for boolean literals and function declarations

## [0.3.1] - 2026-03-11

### Changed

- Simplified packaging to a single platform-agnostic VSIX artifact
- Excluded stale server assets from packaged extensions
- Updated CI, release workflow, and README to match the syntax-highlighting-only extension scope

## [0.3.0] - 2026-03-11

### Changed

- Simplified the extension to syntax highlighting only
- Removed tree-sitter-based runtime parsing, document symbols, and folding support
- Improved highlighting for newer Compact syntax forms, including `type`, `new type`, `from`, declared type names, and generic built-in types
- Refreshed `lottery.compact` as a manual syntax verification sample
